// ─────────────────────────────────────────────
//  Mock data for Legacy Code Whisperer dashboard
// ─────────────────────────────────────────────

export const repoInfo = {
  name: "legacy-ecommerce-api",
  url: "github.com/codexmatrix/legacy-ecommerce-api",
...
export const overallProgress = 45; // percent
...
export type StepStatus = "completed" | "executing" | "pending" | "failed";
...
export const executionState = {
  ...
  testsRunning: true,
  testResults: null as null | { passed: number; failed: number; total: number },
};

export const rollbackScenario = {
  step: planSteps[2],
  failedTest: {
    name: "POST /orders — order total preserves float precision",
    file: "test/routes/orders.test.js",
    line: 88,
    expected: "199.99",
    received: "200",
    error:
...
// ─────────────────────────────────────────────
//  Verification results mock data
// ─────────────────────────────────────────────
...
export const verificationResults = {
  ...
  coverage: 91,
  coverageNote:
    "91% behavioral coverage of public API endpoints. Generated by IBM Bob before any changes were applied. These tests verify that existing behavior is preserved, not that new behavior is correct.",
  tests: [
    ...
    { name: "POST /orders — order total preserves float precision", file: "test/routes/orders.test.js", line: 88, status: "failed", duration: "55ms", error: "AssertionError: expected 199.99 to equal 200 — var-to-const shadowed accumulator." },
...
// ─────────────────────────────────────────────
//  Final report mock data
// ─────────────────────────────────────────────

export const reportData = {
  repo: "legacy-ecommerce-api",
  runtimeUpgrade: "Node.js 12.x → 18 LTS",
  ...
  rollbacks: [
    {
      ...
      recovery: "Repository restored to state after Step 2 (27/27 tests passing)",
    },
  ],
  auditTrail: [
    ...
    { time: "10:40:58", type: "success", message: "IBM Bob: Safety-net generated — 27 behavioral tests" },
    ...
    { time: "10:41:28", type: "success", message: "Verification: 27/27 passed — Step 1 committed" },
    ...
    { time: "10:43:14", type: "success", message: "Verification: 27/27 passed — Step 2 committed" },
    ...
    { time: "10:45:10", type: "warn", message: "Verification: 1 test failed — POST /orders float precision" },
    { time: "10:45:14", type: "error", message: "Regression detected — initiating rollback" },
    { time: "10:45:15", type: "warn", message: "Rolling back Step 3 changes…" },
    { time: "10:45:16", type: "success", message: "Rollback complete — repository restored to post-Step-2 state" },
    { time: "10:45:16", type: "success", message: "Verification: 27/27 passed after rollback" },
  ...
  ] as Array<{ time: string; type: "info" | "success" | "warn" | "error"; message: string }>,
};
